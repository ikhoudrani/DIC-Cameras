...
def acquire_and_display_images(cam, nodemap, nodemap_tldevice, i):
    """
        ...
        while(continue_recording):
            try:
                ...
                if image_result.IsIncomplete():
                    ...
                    plt.scatter(image_data.shape[1]/2, image_data.shape[0]/2, s=1, color='red', marker = '+', linewidths=320) #Create the red cross in the center of the image
...
def run_single_camera(cam, i):
    ...
    try:
        ...
        # Modifier les lignes suivantes afin de pouvoir entrer manuellement les paramètres
